function [out1] = bisectionFunctChalcoVer0(k)
...
for krate = 1:length(Const)
    ...
    for j = 1:8
           ...
           B(j,krate) =  unetCombinedSimpsonLINEChalcover1(0,1,t+j,10,rateconstant,type);
           Z(j,krate) = unetCombinedSimpsonLINEChalcover1derive(0,1,t+j,10,rateconstant,type);
